...
SoftwareSerial mySerial(14,12); // rx, tx (NodeMCU ESP8266 : D5,D6)
...
void setup() {
  ...
  // contineous data
  mySerial.write(0xA5); // header
  mySerial.write(0x45); // command
  mySerial.write(0xEA); // checksum

  // query data
  //mySerial.write(0xA5); // header
  //mySerial.write(0x15); // command
  //mySerial.write(0xBA); // checksum
}
